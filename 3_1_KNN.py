# -*- coding: utf-8 -*-
"""
Created on Sun Jul 13 21:12:14 2025
...
#(2) Makine öğrenmesi modelinin secilmesi - KNN sınıflandırıcı
...
knn.fit(X_train, y_train) #fit fonksiyonu verimiz (sample + target) kullanarak knn algoritamsını egitir

#(4) Sonucların degerkendirilmesi: tests
...
plt.title("K degereine gore dogruluk")
plt.xlabel("K degeri")
plt.ylabel("Dogruluk")
plt.xticks(k_values)
plt.grid(True)
